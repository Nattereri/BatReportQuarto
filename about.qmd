...
**Reporting Bat Survey Data** complements the *data science* chapter in the 4^th^ Edition of the Bat Survey Guidelines published September 2023. Unlike the guidelines it has the R code making the analysis; which can be copied and used.
