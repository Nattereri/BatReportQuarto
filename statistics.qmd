...
@fig-NMDSlabelplots shows the 2D @fig-NMDSplots-1 labelled for static location (@fig-NMDSlabelplots-1) and month (@fig-NMDSlabelplots-2); the static location in @fig-NMDSlabelplots-1 are in separate groups more than the more random groupings shown for months in @fig-NMDSlabelplots-2.
