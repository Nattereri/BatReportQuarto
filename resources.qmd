...
-   [Coding Club](https://ourcodingclub.github.io/) for ecologists and environmental scientists.
...
The [Office for Statistics Regulation](https://osr.statisticsauthority.gov.uk/) the independent regulatory arm of the [UK Statistics Authority](https://uksa.statisticsauthority.gov.uk/) produces two key reference documents that have relevance for data scientists that publish in the public domain[^20]
