...
***Note: pages are under active construction*** (so some things won't look right!)

![](Images/homesunrise2.png)

To help ecologists get started, the code making all the graphs and analysis is freely available to copy and use; just click on  _Show the code_, copy to the clipboard [^2], paste into the R environment and run (to get going in R see @sec-installr). 
