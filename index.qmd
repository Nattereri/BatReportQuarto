...
The term _Data Science_ is used, as this covers data collection, management, processing, analysis, visualization, interpretation and reporting. Interesting to note; statisticians would state this is what they have always done [@Daviddonoho201750:9bd5].

The data science is applied through literate programming [@knuth_literate_1984] outlined in @fig-workflowred. This enables efficient reporting of bat data[^8] from a simple table, such as a count of bats, to the output and interpretation of machine learning in a fully formatted report; plus everything in-between, all can be accomplished through open source R[^9] [@R-base] and RStudio [@RStudio22]. 

![Literate Programming](Images/workflowRed.png){#fig-workflowred}

Much is said about the digital skills gap [^20]; if only in a small way, these data science pages aim to improve our digital skills by giving a practical approach of accessing modern data science methods[^21]. For a balanced understanding of the link between digital skills and data science see the [Royal Statistical Society article](https://realworlddatascience.net/news-and-views/editors-blog/posts/2023/02/14/digital-skills.html)

You may ask what's wrong the spreadsheet for data science? On a practical level spreadsheets are hard to maintain, find errors in or see there was an error in the first place, they are poor at handling dates and difficult to share with others.  For the blunders of spreadsheet use listen to [Spreadsheet disasters](https://www.bbc.co.uk/sounds/play/w3ct3k5z) on BBC sounds from the World Service program _More or less_; the broadcast refers to Matt Parker's book _Humble Pi A comedy of Maths Errors_ [@Mattparker2019Humble:61dc]. On a positive note spreadsheets are handy and easy to use for a few lines of data.
...
[^21]: The Chartered Institute of Ecology and Environmental Management (CIEEM) a leading institute for professional ecologists has a competency framework members are required to fulfill; this does not mention statistics or data science
