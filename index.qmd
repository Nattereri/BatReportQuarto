...
To help ecologists get started, the code making all the graphs and analysis is freely available to copy and use; just click on the _Show the code_ text, copy to the clipboard [^2]and paste into the R environment and run (to get going in R see Install R... section below). 
