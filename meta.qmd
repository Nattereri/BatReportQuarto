...
Common bat names are readily understood by the lay reader and should be available for graphs and tables; it is easily added as column using the _Scientific_ names column as a starting point.
