...
* two or more species in one cell (see Table \@ref(tab:table02));
* count of bats (Tables \@ref(tab:table03)); and, 
* two of more columns with species of same date and time.
* Longitude and Latitude columns with missing values

While the bat survey results shown in Table \@ref(tab:table01) is an example of a _tidy_ data set; the data sets in Tables \@ref(tab:table02) and \@ref(tab:table03) are _untidy_ and would need to be made tidy to undertake analysis.
