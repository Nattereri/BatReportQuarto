...
While the bat survey results shown in Table @tbl-tidy is an example of a _tidy_ data set; the data sets in @tbl-untidy1 and @tbl-untidy2 are _untidy_ and would need to be made tidy to undertake analysis.
